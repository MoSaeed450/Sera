...
export default function LanguageSwitcher() {
  ...
  return (
    <div className={`flex items-center gap-6 px-4  border ${pathname === "/" ? "border-white" : "border-[#6b4423]"} p-1 rounded-2xl`}>
      <button
        ...
        className={`
          ...
          disabled:opacity-50
          ${currentLocale === 'ar' && pathname === "/" 
            ? 'text-white hover:text-white/75 scale-105' 
            : 'text-white/60 '} 
          ${currentLocale === 'ar' && pathname === "/ar/Legacy" 
            ? 'text-[#6b4423] hover:brightness-75 scale-105' 
            : 'text-[#6b4423]/50 hover:text-[#6b4423]/30'}
            `}
